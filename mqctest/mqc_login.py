...
class MqcTest(TestCase):
    ...
    def test_firstcase(self):
        steps = [
                ...
                #点击控件：填写你的手机号
                ['click', None, 'com.qingsongchou.social:id/et_number_input', '填写你的手机号', None, None, None],
                #在控件 填写你的手机号 上输入 111111111
                ...
                #点击控件：登录
                ['click', None, 'com.qingsongchou.social:id/bt_login', '登录', 389.0, 795.0, None],
                ]
        self.drive(steps)
